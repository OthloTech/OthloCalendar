...
type APIResource interface {
	Options(session *Session, url string, queries url.Values, body io.Reader) (APIStatus, interface{})
	Get(session *Session, url string, queries url.Values, body io.Reader) (APIStatus, interface{})
	Post(session *Session, url string, queries url.Values, body io.Reader) (APIStatus, interface{})
	Put(session *Session, url string, queries url.Values, body io.Reader) (APIStatus, interface{})
	Patch(session *Session, url string, queries url.Values, body io.Reader) (APIStatus, interface{})
	Delete(session *Session, url string, queries url.Values, body io.Reader) (APIStatus, interface{})
}
...
func (APIResourceBase) Post(session *Session, url string, queries url.Values, body io.Reader) (APIStatus, interface{}) {
	return FailSimple(http.StatusMethodNotAllowed), nil
}
